...
def box_label(screen, text, dimensions):
	...
	pg.draw.rect(screen, COLOR[0], base, 0) #Draw base
...
def cast_shadow(screen):
	...
	shadow.fill((0,0,0,210)) #RGB + Transparency
...
def main():
	...
	#Start in fullscreen, escape to 800x645px
	...
	while running: #Game loop
		...
		if sat.fuel <= 0:
			...
			sat.fuel, sat.dx = 0, 2 #Cause sat to fly off screen
			sat.thrust.stop()
		...
		instruct_label(screen, instruct_text1, COLOR[0], 10, 575)
		instruct_label(screen, instruct_text2, COLOR[0], 575, 510)
